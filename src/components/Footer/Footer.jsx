...
export default function Footer() {
  return (
    <footer className="bg-gray-50    dark:bg-gray-800 flex justify-center">
      <div className="px-8 py-5 container">
        <h3 className="capitalize text-3xl text-gray-500 dark:text-gray-200">
          get the freshCart app
        </h3>
        <p className="text-gray-400 mb-3 mt-1 dark:text-gray-300">
          We will send you a link, open it on your mobile phone to download the app.
        </p>
        ...
        <form className="flex items-center">
          <input
            type="email"
            id="app-download"
            className="outline-green-400 transition-all ms-6 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-5 p-2.5"
            placeholder="Email..."
            required
          />
        ...
        <div className="flex flex-col  gap-5 md:flex-row justify-between my-8 border-y-1 border-gray-200  dark:border-gray-300 py-6 px-4">
          <div className="flex items-center justify-start space-x-3">
            <p className="capitalize text-gray-600 dark:text-gray-300">payment partners</p>

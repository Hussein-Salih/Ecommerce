  ...
  return (
    <div className="my-5">
      <div className="container mx-auto p-6 grid grid-cols-6">
        <div className="bg-red-500 dark:bg-red-700 col-span-4">
          <Swiper
            slidesPerView={1}
            loop={true}
        ...
        <div className="bg-blue-500 dark:bg-blue-700 col-span-2">
        ...
        >
          {allCategoriesData?.map((cat) => (
            <SwiperSlide className="mx-2" key={cat._id}>
              ...
              <div className="text-center text-lg font-normal dark:text-gray-200">
                {cat.name}
              </div>
            </SwiperSlide>
          ))}
      ...
      {isLoading ? (
        <div className="w-full bg-green-400 dark:bg-gray-800 text-white font-medium capitalize text-2xl h-screen flex justify-center items-center">
            ...
            <form className="max-w-md mx-auto">
              <div className="relative">
                ...
                <input
                  type="search"
                  id="default-search"
                  className="block w-full py-3 px-10 ps-10 text-sm text-gray-900 dark:text-gray-100 border outline-green-400 transition-all border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 focus:ring-blue-500 focus:border-blue-500"

...
export default function Navbar() {
  ...
  const { numOfWishlistItems, getWishlistItems } = useContext(WishlistContext);
      ...
      <div className="container flex flex-wrap items-center justify-start mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse ms-auto">
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center p-2 w-10 h-10 md:ms-3 justify-center text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
        ...
        <div
          ...
          } items-center justify-between w-full lg:flex lg:w-auto lg:order-1 order-3 ms-5 transition-all`}
          id="navbar-sticky"
        >
